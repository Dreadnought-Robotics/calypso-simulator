...
#include <calypso_thruster/ThrusterConversionFcn.hh>
#include <calypso_thruster/Dynamics.hh>
...
typedef const boost::shared_ptr<const calypso_msgs_thruster::msgs::Double>
ConstDoublePtr;
